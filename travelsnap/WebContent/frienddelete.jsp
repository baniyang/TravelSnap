...
<title>Friends Deleted Successfully!</title>
...
<body>
	...
	<%
	    ...
	    String DeleteFriendID = "'0'";
	    if (DeleteIDs != null) {
			for (int i = 0; i < DeleteIDs.length; i++) {
			    DeleteFriendID = DeleteFriendID + ",'" + DeleteIDs[i] + "'";
			}
	    }

	    //delete
	    if (friend.delete(DeleteFriendID)) {
	%>
	<div id="wrap">
		<div class="header">
			<div class="logo">
				...
				<div class="feat_prod_box_details">
					<div class="prod_det_box">
						...
						<div class="box_center">
							<p class="details">Friends Deleted Successfully!</p>
							<p class="details">
								<a href="friendmanage.jsp">Back to Manage Friends</a>
							</p>
							<p class="details">
