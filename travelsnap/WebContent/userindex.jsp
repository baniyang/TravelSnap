	...
	<div id="wrap">
		...
		<div class="center_content">
			...
			<div class="left_content">
				...
				<div class="feat_prod_box_details" id="userinfo"
					style="display: none;">
					<div class="prod_img">
				...
				<div id="demo" class="demolayout">
					...
					<div class="tabs-container">
						...
						<div style="display: block;" class="tab" id="tab1">
                         <div class="feat_prod_box_details">
							...
							<ul class="list">
								...
								</a> <br /> Post Time: <%=rs.getString("time").substring(0, 16)%><br />
									<%
										}
									%>
								</li>
						...
						<div style="display: none;" class="tab" id="tab2">
							<iframe frameborder="0" src="map.view?user=<%=UserName%>" width="450"
								height="450"></iframe>
